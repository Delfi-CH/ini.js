...
try {
  console.error(
    "Async parsing of invalid file was sucessfull!:" +
      (await iniFileToObject("data/incorrect.ini")),
  );
} catch (err) {
...
try {
  console.error(
    "Sync parsing of invalid file was sucessfull!:" +
      iniFileToObjectSync("data/incorrect.ini"),
  );
} catch (err) {
